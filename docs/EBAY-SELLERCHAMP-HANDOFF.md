...
**Status:** planning document for [ROADMAP.md](./ROADMAP.md) Phase 6 — not implemented yet.

**Goal:** Extend the Listing Generator workflow so high-demand SKUs can flow from the portal (copy, photos guidance, pricing context) into **eBay** with optional **SellerChamp** automation, without breaking today’s manual Marketplace / OfferUp / Craigslist flow.

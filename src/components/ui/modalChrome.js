...
export const MODAL_CENTER_BACKDROP =
  'fixed inset-0 z-50 flex min-h-0 flex-col bg-black/70 p-0 sm:flex sm:items-center sm:justify-center sm:p-4'
...
export const MODAL_CENTER_BACKDROP_TOP =
  'fixed inset-0 z-[100] flex min-h-0 flex-col bg-black/70 p-0 sm:flex sm:items-center sm:justify-center sm:p-4'

/** Shared panel layout (add `max-w-*` for width). Full-screen below `sm`, capped dialog from `sm`. */
export const MODAL_CENTER_PANEL_BASE =
  'mx-auto flex min-h-screen w-full flex-1 flex-col overflow-y-auto rounded-none border border-zinc-700 bg-zinc-900 shadow-2xl sm:min-h-0 sm:max-h-[90vh] sm:flex-none sm:rounded-2xl'
